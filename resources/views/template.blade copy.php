              ...
              <div class="swiper sliderFeaturedPosts">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('front/assets/img/post-slide-1.jpg');">
                  ...
                  <div class="swiper-slide">
                    <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('front/assets/img/post-slide-2.jpg');">
                      <div class="img-bg-inner">
                  ...
                  <div class="swiper-slide">
                    <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('front/assets/img/post-slide-3.jpg');">
                      <div class="img-bg-inner">
                  ...
                  <div class="swiper-slide">
                    <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('front/assets/img/post-slide-4.jpg');">
                      <div class="img-bg-inner">
            ...
            <div class="col-lg-4">
              <div class="post-entry-1 lg">
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{ asset('front/assets/img/person-1.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
