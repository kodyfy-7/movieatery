        ...
        <section>
            <div class="row blog-post-row">
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_4.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
                ...
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_5.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
            ...
            <div class="row blog-post-row">
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_6.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
                ...
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_7.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
            ...
            <div class="row blog-post-row">
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_8.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
                ...
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_9.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
            ...
            <div class="row blog-post-row">
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_10.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
                ...
                <div class="col-md-6 blog-post" data-aos="fade-up">
                    <div class="blog-post-thumbnail-wrapper">
                        <img src="{{ asset('front/assets/images/blog_11.jpg') }}" alt="blog post">
                    </div>
                    <p class="blog-post-category">Blog post</p>
                    <a href="#!" class="blog-post-permalink">
                        <h6 class="blog-post-title">Front becomes an official Instagram Marketing Partner</h6>
